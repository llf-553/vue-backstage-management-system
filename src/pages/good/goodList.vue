  ...
  <div class="qf-goodlist">
      ...
      <!--栅格系统-->  <!--一列24等份-->
        <el-row type="flex" align="bottom">
          <el-col :span="2" ><div class="qf-filter-labe">名称搜索:</div></el-col>
          <el-col :span="4">
            <el-input  clearable v-model="filter.searchText" size="mini " @change="textFilter"></el-input>
          </el-col>
          <el-col :span="3" :offset="1"><div class="qf-filter-labe">品类筛选:</div></el-col>
          <el-col :span="4">
              
              <CateSelect @change='cateFilter' clearable v-model="filter.cate"  size="mini "></CateSelect>
            
          </el-col>

          <el-col :span="4" :offset="4">
            <div style="textAlign:right">
              <el-button type="primary" :round="true" @click="skipToAdd" size="mini">新增<i class="el-icon-upload el-icon--right"></i></el-button>
            </div>
          </el-col>
        ...
        <el-row  type="flex" align="bottom">
           ...
           <el-col :span="2"><div class="qf-filter-labe">日期筛选:</div></el-col>
          <el-col :span="6">
             <el-date-picker
                v-model="filter.date"
                type="daterange"
    ...
    methods: {
      ...
      delGood(item){
        console.log("item",item)
          this.$confirm(`你确定要删除 ${item.name}吗?`, '提示', { 
